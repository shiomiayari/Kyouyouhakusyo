...
いみじううつくしき児（ちご）の、いちごなど食ひたる。`}
      ...
      <section className="py-6 px-4 sm:px-6 lg:px-12">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-[#E1BEE7] to-[#B3E5FC] p-5 md:p-8 rounded-3xl border-4 border-white">
      ...
      <section className="py-6 px-4 sm:px-6 lg:px-12">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-[#2A3B5A] p-5 md:p-8 rounded-3xl border-2 border-white/20">
              <h3 className="text-xl md:text-2xl font-bold text-[#E1BEE7] mb-4">👘 「色」のレイヤード</h3>
            ...
            <div className="bg-[#2A3B5A] p-5 md:p-8 rounded-3xl border-2 border-white/20">
              <h3 className="text-xl md:text-2xl font-bold text-[#B3E5FC] mb-4">🍧 平安時代のスイーツ</h3>
              <p className="text-base md:text-lg text-white/90 leading-relaxed">
            ...
            <div className="bg-[#2A3B5A] p-5 md:p-8 rounded-3xl border-2 border-white/20">
              <h3 className="text-xl md:text-2xl font-bold text-[#FFFFFF] mb-4">🥚 「白さ」への執着</h3>
              <p className="text-base md:text-lg text-white/90 leading-relaxed">
            ...
            <div className="bg-[#2A3B5A] p-5 md:p-8 rounded-3xl border-2 border-white/20">
              <h3 className="text-xl md:text-2xl font-bold text-[#FFC2D1] mb-4">🍓 「無垢」と「赤」のコントラスト</h3>
              <p className="text-base md:text-lg text-white/90 leading-relaxed">
